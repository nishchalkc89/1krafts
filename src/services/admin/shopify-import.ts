...
// Fixes the common "Â " mojibake that shows up when a UTF-8 non-breaking
// space gets misread as Windows-1252 — a frequent artifact in CSVs exported
// from other systems, not something specific to Shopify's format.
