...
import saree from "@/assets/cat-saree-nepali.png";
...
export const CATEGORIES: Category[] = [
  { slug: "sarees", name: "Sarees", tagline: "Draped in heritage", description: "Hand-loomed silks and cottons finished with woven Dhaka borders.", image: saree, featured: true, order: 1 },
